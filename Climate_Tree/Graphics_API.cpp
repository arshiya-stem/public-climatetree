...
void Graphics_API::UpdateGraph(int d1, int d2, int d3, int d4, int d5, int d6) {
  int sensors[numSensors] = {d1, d2, d3, d4, d5, d6};
  ...
  y[3] = graphY + graphHeight - map(sensors[3], 0, 14, 0, graphHeight);
  y[4] = graphY + graphHeight - map(sensors[4], 0, 100, 0, graphHeight);
  y[5] = graphY + graphHeight - map(sensors[5], 0, 100, 0, graphHeight);
