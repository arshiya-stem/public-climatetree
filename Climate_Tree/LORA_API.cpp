...
void LORA_API::Send_Data(float sensor_data1, float sensor_data2, float sensor_data3, float sensor_data4, float sensor_data5, float sensor_data6) {
  String send = "AT+SEND=1:0:01" 
                ...
                + IntToHexString(sensor_data5, 4) 
                + IntToHexString(sensor_data6, 4);  
